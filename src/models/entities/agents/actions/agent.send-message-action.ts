      ...
      default:
        return z.object({
          message: z
            ...
            .describe(
              `Your message in character voice (max ${messageLengthLimit} chars). Follow location formatting rules. CRITICAL: Review <LocationMessages> and <YourLastMessage>—never repeat phrases/patterns.`
            ),
          expression: z
            .string()
            .max(messageLengthLimit)
