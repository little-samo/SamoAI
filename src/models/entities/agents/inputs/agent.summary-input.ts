...
3.  **Capture Key Interactions & Decisions:** Include *only the most important* user requests, agent responses, significant agent observations, confirmations, agreements, disagreements, or pivotal conversation moments relevant to the ongoing state *within the current Location*, **always adding date strings.**
